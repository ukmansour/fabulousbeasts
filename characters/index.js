    ...
    '메인 캐릭터': {
        '비휴 형제': {
            tianlu: { 
                ...
                appearance_debut: `천록(天禄/Tiānlù톈루), 또는 흔히 피피라는 별명으로 불리는 유수언의 주인공인 비휴로, 벽사의 쌍둥이 동생이다.<br><br>현대의 지구에서 인간들을 피해 몸을 숨기고 안식처를 찾던 그는 옛 동료인 사불상과 재회하게 된다. 사불상은 자신의 집이자 가게인 녹인점에서 일해주는 조건으로 그가 그곳에 머물도록 허락한다.`,
            ...
            pixiu: { 
                ...
                appearance_debut: `천록의 쌍둥이 형, 천계의 감시를 피해 자신의 존재를 숨기며 다니고 있다.`,
