...
export const CHARACTERS = [
    ...
    { 
        ...
        infobox: `
            <div class="infobox">
                ...
                <div class="infobox-row"><strong>가족 관계:</strong> 벽사(쌍둥이 형), 사불상(의형제/형)</div>
    ...
    { 
        ...
        appearance_debut: `천록과 함께 태어난 비휴.`,
        ...
        infobox: `
            <div class="infobox">
                ...
                <div class="infobox-section-title">별명 및 호칭</div>
                <div class="infobox-row">양각피휴(两角貔貅), 홍비휴(红貔貅), 샤오메이화(小메화 - 애칭), 디디(弟弟 - 호칭), 피피(피피 - 투예의 착각), 라오다(老大)</div>

                <div class="infobox-section-title">관계</div>
                <div class="infobox-row"><strong>가족:</strong> 천록(남동생), 사불상(의형제)</div>
