...
export const DETAIL_SECTIONS = [
    { id: 'appearance_debut', label: '등장', num: 1 },
...
export const CHARACTERS = [
    ...
    { 
        ...
        appearance_debut: `첫 화부터 능력을 노리는 인간들에게 쫓기는 모습으로 등장한다. 이후 옛 친구인 사불상과 함께 녹인점에 거주중이다.`,
    ...
    { 
        ...
        appearance_debut: `웹툰 100화, 애니 24화에서 처음 등장하며 천록의 뱃속에서 나와 분리수거를 하는 모습으로 나온다. 고대에 한 알에서 천록과 쌍둥이로 태어났으며 벽사가 형이다.`,
        appearance: `벽사는 쌍둥이 형제인 천록과 매우 비슷한 외모를 가지고 있다. 마찬가지로 몸 대부분이 흰색 털로 덮여 있으며 몸 곳곳에 장식 무늬가 있다. 다만 천록의 무늬가 파란색인 것과 달리 벽사의 무늬는 붉은색이다. 또한 천록이 엉덩이 부분에 파란 원형 무늬를 가지고 있는 것과 달리, 벽사는 붉은 매화 문양이 있다.<br><br>눈 색 역시 천록과 반대되는 그라데이션을 띠며, 연두빛에서 노란색으로 이어진다. 머리 위에는 귀 사이에 노란색 뿔 두 개가 나 있다. 과거 어린 시절 도철과 싸우는 동안 도철에게 왼쪽 귀를 물려 귀 윗부분이 패인 상처가 생겼으며, 이 흉터는 지금까지 남아 있다.<br><br><b>2.1 원래 모습:</b> 천록과 마찬가지로 벽사의 <b>“원래 모습”</b>은 기본 형태가 성장한 것과 같은 모습이다. 더 큰 개과 동물처럼 보이며 훨씬 사납고 공격적인 분위기를 띤다. 몸과 각 특징은 더욱 길고 커지며 날카로워지고, 분노하거나 위협할 때는 털을 곤두세울 수. 천록과 마찬가지로 변신 상태에 관계없이 몸의 무늬는 변하지 않으며 귀의 흉터 역시 그대로 유지된다.<br><br><b>2.2 아기 변장:</b> 투예의 계획으로 장장과 리치에게 맡기기 위해 기린과 천마의 혼혈 아이인 것처럼 위장한 적이 있다. 이를 위해 벽사는 몸을 아기 모습으로 줄였으며, 꼬리는 천마처럼 말려 보이도록 다듬었다. 또한 토보서가 준 분홍색 마니 구슬을 먹어 붉은 털을 분홍색으로 물들였다.`,
    ...
    { 
        ...
        name_origin: `<b>토야(토끼 兔, 아비 爷):</b> 문자 그대로 <b>“토끼 어르신” 또는 “토끼 대인”</b>이라는 의미를 가진다. 이 이름은 중국 민속 전승과 관련되어 있으며 두 가지 유래가 추정된다.<br><br>첫 번째는 <b>토아야(兔儿爷)</b>에서 유래했을 가능성이다. 토얼예는 중국 민속에서 항아와 함께 달에 사는 옥토끼를 가리키는 존재이다.<br>두 번째는 <b>토아신(兔儿신)</b>과 <b>대야(大爷)</b>의 이름이 합쳐졌을 가능성이다. 토아신은 중국 민간 신앙에서 토끼와 남성 간 사랑을 관장하는 신으로 전해진다.<br><br>또한 공식 설정에서는 그의 영어 이름이 토니라고 표시되어 있다.`,
