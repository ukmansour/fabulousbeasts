...
export const CHARACTERS = [
    ...
    { 
        ...
        infobox: `
            <div class="infobox">
                ...
                <div class="infobox-section-title">별명 및 호칭</div>
                <div class="infobox-row">양각비휴(两角貔貅), 홍비휴(红貔貅), 매화꽃/샤오메이화(小梅花 - 사불상이 부르는 애칭), 남동생(弟弟 - 사불상이 부르는 호칭), 피피(皮皮 - 투예의 착각(애니 40화)), 대장님(老大 - 병아리 부하들이 부르는 호칭)</div>
    ...
    { 
        ...
        infobox: `
            <div class="infobox">
                ...
                <div class="infobox-row"><strong>성우:</strong> 학상해 (郝祥海 - 만화 오디오), 도아 (涂야 - 애니), 유유 (幽幽 - 애니 어린 시절)</div>
                <div class="infobox-row"><strong>등장 작품:</strong> 《비인재》</div>
            </div>
        `
    },
    ...
    // --- 녹인점 ---
    {
        ...
        appearance_debut: `모티브는 서유기의 금각은각형제. 상당히 우애 좋은 형제이며 금각이 형이다. 원래 인간의 모습으로 천계에 살았으나, 사고를 일으키고 쥐의 모습으로 지상으로 쫓겨나는 벌을 받는다. 각각의 머리에 금, 은으로 된 뿔이 두 개씩 달려있는데, 사불상에게 도움을 받은 대가로 서로가 하나씩 떼어서 넘겨 주었다.<br><br>본래 태상노군의 화로를 수천 년간 지키던 인간 형태의 동자들이었다. 그러나 단약을 태워버리거나, 은각의 실수로 화로를 폭발시키는 사건을 일으켜 스승의 노여움을 샀다.<br><br>그 결과 인간계로 추방됨과 동시에 친칠라의 모습으로 변하는 형벌을 받았으며, 추방 과정에서 서로 헤어지게 되었다. 이후 은각이 사불상을 만나 자신의 뿔 두 개를 대가로 형을 찾아달라는 계약을 맺었고, 우여곡절 끝에 재회에 성공했다. 하지만 금각은 뿔이 자신들의 정체성이라며 계약 이행을 거부했고, 결국 형제가 각자 뿔 하나씩을 내어주는 것으로 합의를 보았다. 현재는 사불상의 가게에서 일하며 잃어버린 뿔을 되찾기 위해 노력 중이다.`,
        appearance: `<b>본래 모습:</b> 긴 머리에 머리 위 한 쌍의 뿔이 있는 소년의 형태를 하고 있었다.<br><br><b>현재 모습:</b> 추방 이후 쥐의 모습을 한 작은 동물로 변했다.<br><br><b>금각:</b> 금색 털을 가졌으며, 왼쪽 뿔이 없다.<br><br><b>은각:</b> 은색 털을 가졌으며, 오른쪽 뿔이 없다.<br><br><b>기타:</b> 현재는 화예조가 3D 프린터로 제작해 준 뿔을 착용하여 없는 부위를 대체하고 있다.`,
        personality: `금각 : 상당히 게으른 편이며, 천계로 돌아가기 위해 노력하는 일에 큰 의욕이 없다. 동생보다 식탐이 강해 더 많은 양의 음식을 섭취한다. 여러 단점에도 불구하고 형로서 동생을 아끼는 보호 본능이 강하다.`,
        ability: `대상이나 영수에게 대량의 마나를 주입할 수 있는 능력을 갖추고 있다. 과거 천계에서 화로를 다룰 때 사용하던 기술이다.<br><br>각종 재료를 사용하여 단약이나 엘릭서를 제조할 수. 작중에서는 스스로 불로장생약을 완성하기 위해 연구를 지속하고 있다.<br><br>겉보기에는 약해 보이나 매우 빠른 발을 가지고 있어, 천록에게서 뿔을 가로채 도망칠 수 있을 정도의 순발력을 자랑한다.<br><br><b>4.2. 주요 법구:</b> 봉인의 도토리: 서유기의 '자금홍호로'를 모티브로 한 강력한 유물이다. 상대의 이름을 불러 대답하면 도토리 안으로 빨아들인다.<br><br><b>기타 유물:</b> 칠성검, 팔괘도포, 음양경, 태극도, 파초선 등 수많은 천계의 보물을 소지하고 있다.<br><br><b>패러디 아이템:</b> 작중 설정상 데스노트, 카드캡터 사쿠라의 봉인 지팡이, 토르의 묠니르 등 타 작품을 패러디한 도구들도 다수 보유하고 있다.`,
        motif: `서유기에 나오는 요괴 형제. 본래 태상노군의 시종이었지만 그의 물건들을 가지고 도주하였다. 자칭 금각대왕, 은각대왕이라 불리며 요괴들을 부리며 삼장법사의 고기를 노렸다.<br><br>결국 손오공 일행에게 털리고 둘다 봉인되었다가, 자기 도구+시종들을 되찾으러 온 태상노군에게 돌려주자 거기서 나와 다시 시종이 되었다. 사실 이 둘이 갑자기 속세로 내려가 요괴짓을 한 것은 관세음보살님이 손오공 일행에게 시련을 보내기 위해서 한 짓이라고 한다. 자기들이 경 가지러 오라 해놓고 방해하는 건 무슨 심보냐고 손오공도 불평했다.`,
        name_origin: `금각 (쇠 金, 뿔 角) / 진쟈오. 금각은 이름 그대로 '금빛 뿔'을 의미한다.`,
        trivia: `<ul><li>슈뢰딩거의 양 본작의 캐릭터들과 함께 카메오로 출연하였다. 해당 작품 내에서는 이들을 모티브로 한 놀이공원의 마스코트 캐릭터로 등장한다.</li></ul>`,
        yusu_huihwa: ``
    },
    {
        id: 'nok-은각', 
