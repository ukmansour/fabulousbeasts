...
export const CHARACTERS = [
    ...
    { 
        ...
        infobox: `
            <div class="infobox">
                ...
                <div class="infobox-row">비휴(貔貅), 피피(皮皮 - 애칭), 동그라미/샤오란취안(小蓝圈 - 사불상이 부르는 애칭), 피피오빠(皮皮哥-토보서)</div>
    ...
    { 
        ...
        ability: `<b>무한한 위장 / 초강력 소화:</b> 벽사의 뱃속 역시 천록과 마찬가지로 차원 공간과 같은 구조를 가지고 있어 무엇이든 담을 수. 다만 천록의 위장과 달리 내부는 매우 깨끗하며 밝은 흰 공간처럼 보이고 표면에는 액체층이 존재한다. 이 액체는 매우 강한 소화 능력을 가지고 있어 천록이 들어갔을 때 몸에 있던 세균이 순식간에 제거되었다. 다만 오래 머물면 몸이 녹을 수도 있다. 이 특성은 몸 전체에도 적용되어 몸에 들어온 미생물이나 작은 생명체를 제거할 수.<br><br><b>형태 변화:</b> 자신의 크기와 외형을 바꿀 수 있다. 작은 형태로 줄어들거나 거대한 모습으로 변할 수 있으며, 후자는 일반적으로 <b>“원래 모습”</b>이라 불련다.<br><br><b>정리:</b> 천록이 계속 먹어 치워 뱃속이 어지러워지자 벽사는 내부를 정리하여 먹은 물건을 체계적으로 관리하는 시스템을 만들었다. 또한 닭들을 부하로 삼아 관리 업무를 맡기기도 했다.<br><br><b>요리:</b> 요리에 대한 지식과 실력을 가지고 있으며 천록의 뱃속에서 당강을 손질하고 요리한 적도 있다.<br><br><b>예술:</b> 사불상을 찾기 위해 그림 실력을 발전시키기 시작했으며 이후 계속 그림을 그리는 취미를 유지하고 있다.`,
